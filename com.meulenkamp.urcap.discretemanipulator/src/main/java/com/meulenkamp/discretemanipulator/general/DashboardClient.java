...
public class DashboardClient {
    ...
    protected synchronized String send(final String request) {
        if (socket == null) {
            System.err.printf("Can't send '%s'. Connection is closed%n", request);
            return "";
        }
        ...
        try {
            ...
            System.err.printf("Can't read response for '%s': %s%n", request, e);
            return "";
        }
    }
    ...
    public RobotMode robotMode() {
        ...
        if ("-1".equals(response)) {
            ...
            try {
                ...
                System.err.printf("Can't getValue robot mode %s%n", e);
            }
        }
    ...
    public ProgramState programState() {
        ...
        try {
            ...
            System.err.println("Can't getValue program state");
        }
    ...
    public SafetyMode safetymode() {
        ...
        try {
            ...
            System.err.println("Can't getValue safety mode");
        }
